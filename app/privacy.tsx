      ...
      >
        ...
        {SECTIONS.map(({ title, body }, i) => (
          <View key={i} style={{ marginBottom: 20 }}>
            ...
            <Text
              style={{ fontSize: 14, color: colors.foreground, lineHeight: 22 }}
            >
              {body}
            </Text>
          </View>
        ...
        <Text style={{ fontSize: 12, color: colors.muted, marginTop: 8 }}>
          Replace the contact details in Section 9 with your actual email or
          support URL before publishing.
        </Text>
      </ScrollView>
    </ScreenContainer>
  );
