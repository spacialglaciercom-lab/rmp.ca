...
c = c.replace(
  ...
  'import { MapillaryViewer } from "@/components/MapillaryViewer";' + nl +
...
c = c.replace(
  ...
  'const [streetViewVisible, setStreetViewVisible] = useState(false);' + nl +
...
const mapillaryViewer = '<MapillaryViewer' + nl +
  '        latitude={point.latitude}' + nl +
  '        longitude={point.longitude}' + nl +
  '        isVisible={streetViewVisible}' + nl +
  '        onClose={() => setStreetViewVisible(false)}' + nl +
  '      />';
