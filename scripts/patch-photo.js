...
if (!c.includes("  Image,")) {
  console.error("FAIL: Image import");
  process.exit(1);
}
...
if (!c.includes("expo-image-picker")) {
  console.error("FAIL: ImagePicker import");
  process.exit(1);
}
...
if (!c.includes("photoUri")) {
  console.error("FAIL: photoUri state");
  process.exit(1);
}
...
if (!c.includes("handleTakePhoto")) {
  console.error("FAIL: handleTakePhoto");
  process.exit(1);
}
...
if (!c.includes("Photo Section")) {
  console.error("FAIL: Photo Section");
  process.exit(1);
}
