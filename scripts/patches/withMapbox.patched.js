...
exports._addMapboxMavenRepo =
  exports.addMapboxMavenRepo =
  exports.addMapboxInstallerBlock =
  exports.applyCocoaPodsModifications =
  exports.addConstantBlock =
  exports.addInstallerBlock =
    void 0;
...
const addMapboxInstallerBlock = (src, blockName) =>
 ...
 */
const withCocoaPodsInstallerBlocks = (
  config,
  {
    RNMapboxMapsImpl,
    RNMapboxMapsVersion,
  ...
  (0, config_plugins_1.withDangerousMod)(config, [
    ...
    async (exportedConfig) => {
      ...
      let _podfileContents = (0, exports.applyCocoaPodsModifications)(
        contents,
        {
          RNMapboxMapsImpl,
          RNMapboxMapsVersion,
      ...
      _podfileContents = _podfileContents.replace(
        /^\s*end\s+@rnmapbox[^\n]*\n?/gm,
        "",
      );
...
const withAndroidPropertiesDownloadToken = (
  config,
  { RNMapboxMapsDownloadToken } = {},
) => {
  ...
  if (RNMapboxMapsDownloadToken) {
    ...
    return (0, config_plugins_1.withGradleProperties)(
      config,
      (exportedConfig) => {
...
const withAndroidPropertiesImpl2 = (
  config,
...
const appendContents = ({ src, newSrc, tag, comment }) => {
  ...
  if (!src.includes(header)) {
    ...
    const sanitizedTarget = (0, generateCode_1.removeGeneratedContents)(
      src,
      tag,
    );
    const contentsToAdd = [
...
const withAndroidAppGradle = (config, _props = {}) =>
  (0, config_plugins_1.withAppBuildGradle)(
    config,
    ({ modResults, ...exportedConfig }) => {
...
const withAndroidProjectGradle = (config, _props = {}) =>
  (0, config_plugins_1.withProjectBuildGradle)(
    config,
    ({ modResults, ...exportedConfig }) => {
      if (modResults.language !== "groovy") {
        config_plugins_1.WarningAggregator.addWarningAndroid(
      ...
      modResults.contents = (0, exports.addMapboxMavenRepo)(
        modResults.contents,
      );
      return { modResults, ...exportedConfig };
    },
  );
const withMapboxAndroid = (
  config,
  {
    RNMapboxMapsImpl,
    RNMapboxMapsDownloadToken,
