  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ padding: 20, paddingTop: 60 }}>
        ...
        <Text style={[styles.title, { color: colors.foreground, marginBottom: 20 }]}>
          ...
          <View style={styles.processorProgressBar}>
            <View 
              style={[
                ...
                { 
                  width: `${efficiency}%`,
                  backgroundColor: efficiency >= 80 ? colors.success : 
                                  efficiency >= 50 ? colors.warning : colors.primary
                }
              ]} 
            />
          </View>
