...
export const MapWebPluginsSection: React.FC = () => {
  ...
  const markerClustering = useMapWebPluginsStore((s) => s.markerClusteringEnabled);
  const geomanDrawing = useMapWebPluginsStore((s) => s.geomanDrawingEnabled);
  const setMarkerClustering = useMapWebPluginsStore((s) => s.setMarkerClusteringEnabled);
  const setGeomanDrawing = useMapWebPluginsStore((s) => s.setGeomanDrawingEnabled);
  ...
  return (
    <View style={[styles.section, { borderTopColor: theme.borderLight }]}>
      <Text style={[styles.sectionTitle, { color: theme.text }]}>Map plugins (web)</Text>
      ...
      <View style={styles.rows}>
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={[styles.label, { color: theme.text }]}>Marker clustering</Text>
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={[styles.label, { color: theme.text }]}>Drawing & editing</Text>
            <Text style={[styles.description, { color: theme.textTertiary }]}>
