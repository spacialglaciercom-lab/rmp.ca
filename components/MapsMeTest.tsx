  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.surface }]}>
      ...
      {currentPosition && (
        <View style={[styles.positionBox, { backgroundColor: colors.card }]}>
          <Text style={[styles.positionText, { color: colors.text }]}>
            Current Position: {currentPosition.lat.toFixed(6)},{" "}
      ...
      {searchResults.length > 0 && (
        <View
          style={[styles.resultsContainer, { backgroundColor: colors.card }]}
        >
          ...
          {searchResults.map((result, index) => (
            <Text
              key={index}
              style={[styles.resultItem, { color: colors.text }]}
            >
      ...
      <View style={[styles.infoBox, { backgroundColor: colors.card }]}>
        <Text style={[styles.infoText, { color: colors.muted }]}>
          This test component verifies that the MAPS.ME React Native module is
          properly integrated with the trashroute-mobile project.
        </Text>
      </View>
    </View>
  );
