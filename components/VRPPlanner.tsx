...
/**
 * Solve VRP: uses Clarke-Wright savings when algorithm is clarke_wright,
 * Sweep when algorithm is sweep, otherwise zone-based clustering + 2-opt. Depot is always index 0.
 */
function solveVRP(
  matrix: { distance: number; time: number }[][],
  locations: VRPStop[],
